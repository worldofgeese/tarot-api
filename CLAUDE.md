...
- After OpenSpec drafts the change/spec/tasks, use the `tdd` skill (`https://github.com/mfranzon/tdd`) as the canonical implementation loop before claiming progress on code changes.
